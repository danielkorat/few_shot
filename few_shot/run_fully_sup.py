...
def train_and_eval_fully_sup(cmd_args_str):
    # See all possible arguments in src/transformers/training_args.py
    # or by passing the --help flag to this script.
    # We now keep distinct sets of args, for a cleaner separation of concerns.

    sys.argv[1:] = cmd_args_str

    parser = HfArgumentParser((ModelArguments, DataTrainingArguments, TrainingArguments))
    # parser.add_argument("--hwllo", default="bert-base-uncased")
...
def main():
    ...
    #train_file = 'data/lap/asp+op/lap_test_100.json'    
    #test_file =  'data/lap/asp+op/lap_test_100.json'
    train_file = 'data/rest/asp/rest_train_250.json'
    test_file =  'data/rest/asp/rest_test_100.json'
